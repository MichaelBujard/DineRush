...
function registernewuser() {
    //textarea username and password input reference
    var username = document.getElementById("signupusername");
    var password = document.getElementById("signuppassword");

    // actual string value of textarea input
...
// Sync object changes
 var snapshotusersarr = database.child('users').on('value', snap => console.log(snapshotToArray(snap)));
 
 // now we have an array. TO check if a username already exists,
 // simply iterate through the loop and 
